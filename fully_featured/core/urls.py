...
from fully_featured.core.views import glossary_get_view, glossary_group_view, glossary_view, journal_get_view, journal_group_view, journal_view, note_get_view, note_group_view, note_view, test_view, todo_get_view, todo_group_view, todo_view
